...
|-|-|-|
|**Microcontrollers**| | |
|Raspberry Pi 4B|Primary processer - processes camera and LiDAR and controls steering servo and the drive motor|![Rasppi](Bot-Photos/Parts Used/Raspberry Pi 4B.png)|
