...
|Arduino Mega Shield|Circuit board attached to Arduino to fasten wires using screws instead of just plugging in|<Bot-Photos/Parts Used/Arduino Mega Shield.png" alt="Banner" height="150">|
