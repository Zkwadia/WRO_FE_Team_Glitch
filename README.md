...
|MDD10A Motor Driver|<img src="Bot-Photos/Parts Used/MDD10A Motor Driver.png" alt="Banner" height="150">|Single channel motor driver to power and control the drive motors|1|
...
|****Actuators****|
|35KG Servo|<img src="Bot-Photos/Parts Used/35kg Servo.png" alt="Banner" height="150">|Controls angle of the front wheels to steer the robot|1|
|Johnsons Quad 600RPM DC Motor + Encoder|<img src="Bot-Photos/Parts Used/Johnson's Quad DC Motor.jpeg" alt="Banner" height="150">|Controls forward and backward movement of the robot. Uses the encoder for localisation|1|
